...
Next slice: implement agent activity feed from Hermes session metadata (later candidate); or surface per-task list (title/priority/status) inside the board panel for the Warung OS project detail view.
