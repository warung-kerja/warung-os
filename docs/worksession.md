...
Next slice: Morning Brief MVP usefulness pass — turn the Home page into a concise daily operating summary using existing safe snapshot signals (projects, approvals, operations health, source warnings, recent activity) before adding new data sources.
