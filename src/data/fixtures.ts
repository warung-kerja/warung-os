...
export const teamMemberFixtures: CanonicalTeamMember[] = [
  {
    ...
    synced_at: SNAP,
    status: 'active',
    current_task: 'Coordinating Warung OS build handoff to Mia',
  },
  {
    id: 'mia',
    name: 'Mia',
    ...
    synced_at: SNAP,
    status: 'active',
    current_task: 'QA: Warung OS Phase 1 build validation',
  },
  {
    id: 'gabs',
    name: 'Gabs',
    ...
    synced_at: SNAP,
    status: 'waiting',
    current_task: 'Awaiting Raz approval on BofB poster v3 direction',
  },
  {
    id: 'obey',
    name: 'Obey',
    ...
    synced_at: SNAP,
    status: 'active',
    current_task: 'Etsy listing automation — Python API integration',
  },
]
